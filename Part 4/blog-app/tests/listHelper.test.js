...
describe('total likes', () => {
    ...
    test('of empty list is zero', () => {
        const result = totalLikes(listWithZeroBlogs)
...
describe('favorite blog', () => {
    ...
    test('of empty list is null', () => {
        const result = favoriteBlog(listWithZeroBlogs)
...
describe('most likes', () => {
    test('when list has only one blog, returns that author with the likes of that blog', () => {
